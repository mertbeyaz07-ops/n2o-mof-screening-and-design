# -*- coding: utf-8 -*-
"""
Created on Thu May  7 12:14:17 2026
...
train_path = r'C:/Users/mertb/OneDrive/Masaüstü/FINAL DATA/10_50_core_ArC_1_5_qst0_kh/coremof_1_10_arcmof.csv'
arc_path   = r'C:/Users/mertb/OneDrive/Masaüstü/FINAL DATA/10_50_core_ArC_1_5_qst0_kh/arcmof_remain.xlsx'
qmof_path  = r'C:/Users/mertb/OneDrive/Masaüstü/FINAL DATA/10_50_core_ArC_1_5_qst0_kh/QMOF_N2O_Merged_Dataset.xlsx'

save_path = r'D:/NEMO_Visioner_Mert_Beyaz/XGB_TPOT_MAXDEPTH8_SUB055_SCI_SHAP_REVISED.png'
...
print(
    "Train == ARC :",
    list(X_train.columns) == list(X_arc.columns)
)

print(
    "Train == QMOF:",
    list(X_train.columns) == list(X_q.columns)
)
...
# ==========================================
# AXIS RANGE
# Axis goes slightly beyond 13, but labels show up to 12
# ==========================================
